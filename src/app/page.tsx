...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-900 via-sky-200 to-cyan-400 text-white overflow-hidden">
        <div
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center mb-12">
            <span className="inline-block bg-blue-600/50 backdrop-blur-sm border border-blue-400/50 text-blue-100 text-sm font-medium px-4 py-1.5 rounded-full mb-6">
        ...
        <section className="py-16 bg-gray-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-8">
              ...
              <Link
                href="/apartamentos"
                className="hidden sm:flex items-center gap-1 text-sm font-medium text-blue-500 hover:text-blue-700 transition-colors"
              >
                Ver todos
